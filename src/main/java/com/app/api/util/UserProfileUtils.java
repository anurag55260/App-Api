...
/*import com.app.ws.commons.ErrorMessages;
import com.app.ws.exceptions.MissingRequiredFieldException;
...
public class UserProfileUtils {
    ...
    private final String ALPHABETRESIDENT = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    ...
    private String generateRandomResidentId() {
        StringBuilder returnValue = new StringBuilder(10);

        for (int i = 0; i < 10; i++) {
            returnValue.append(ALPHABETRESIDENT.charAt(RANDOM.nextInt(ALPHABETRESIDENT.length())));
        }
    ...
    public String generateResidentId() {
        return generateRandomResidentId();
    }
